...
const server = http_1.default.createServer((req, res) => {
    ...
    if (url === '/posts' && method === 'GET') {
        ...
        getBody().then((body) => {
            ...
            const newPost = Object.assign({ id: posts.length + 1 }, data);
            posts.push(newPost);
        ...
        getBody().then((body) => {
            ...
            if (index === -1)
                return sendJSON(404, { error: 'Post not found' });
            posts[index] = Object.assign({ id }, data);
        ...
        getBody().then((body) => {
            ...
            if (index === -1)
                return sendJSON(404, { error: 'Post not found' });
            posts[index] = Object.assign(Object.assign({}, posts[index]), data);
            sendJSON(200, posts[index]);
        });
        // DELETE /posts/:id
    }
